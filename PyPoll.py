...
# Determine the percenteage of votes for each candidate by looping through the counts.
...
for candidate_name in candidate_votes:
    ...
    # To Do: print out each candidate's name, vote count and the percentage of
